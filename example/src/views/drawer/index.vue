<template>
  <div>
    <Navbar title="Drawer">
      <VButton slot="right" small type="icon" @click="drawerShow('right')">
...
export default {
  name: 'page-drawer',
  methods: {
    drawerShow(direction) {
      this.$store.commit('page/drawerShow', { direction, show: true })
    }
  }
}
</script>
