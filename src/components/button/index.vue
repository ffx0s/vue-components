<template>
  <button
    ...
    :class="[
      ...
      { 'v-button__large': large },
      { 'v-button__small': small },
      { 'v-button__loading': isLoading },
      { 'v-button__fill': fill },
      { 'v-button__block': block },
      { 'v-button__radius': radius },
      { 'v-button__text': text }
    ]"
...
.v-button__loading .v-button-content {
  opacity: 0;
}

.v-button__loading:disabled {
  opacity: 1;
  cursor: default;
}
...
.v-button__block + .v-button__block {
  margin-left: 0;
  margin-top: 14px;
}
</style>
